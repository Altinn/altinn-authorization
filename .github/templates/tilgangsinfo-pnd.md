...
- [ ] Deploy[^1] all components to production[^2].
  ...
  - [ ] Deploy [Auditlog](https://github.com/Altinn/altinn-auth-audit-log/actions) to production.
...
- [ ] Post-deploy[^3] all components in production.
  ...
  - [ ] Post-deploy of auditlog, verify that the [auditlog](https://portal.azure.com/#@ai-dev.no/resource/subscriptions/1ab2d164-1861-4ff8-be8c-069c3ee3b70a/resourceGroups/auditlog-prod-rg/overview) container app and function app is up and running
...
- [ ] Deploy[^1] all components to TT02.
  ...
  - [ ] Deploy [Auditlog](https://github.com/Altinn/altinn-auth-audit-log/actions) to TT02.
- [ ] Deploy updates to APIM (if updated since last deploy)
...
- [ ] Post-deploy[^3] all components in TT02.
  ...
  - [ ] Post-deploy of auditlog, verify that the [auditlog](https://portal.azure.com/#@ai-dev.no/resource/subscriptions/dd6d3e08-a70f-4f71-8847-781ddc5d8468/resourceGroups/auditlog-tt02-rg/overview) container app and function app is up and running
