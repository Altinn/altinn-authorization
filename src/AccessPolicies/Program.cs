...
void Configure()
{
    ...
    app.UseSwagger(o => o.RouteTemplate = "accesspolicies/swagger/{documentName}/swagger.json");

    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/accesspolicies/swagger/v1/swagger.json", "Altinn AccessPolicies API");
        c.RoutePrefix = "accesspolicies/swagger";
    });
