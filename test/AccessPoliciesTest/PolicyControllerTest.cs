...
namespace Altinn.Platform.Authorization.IntegrationTests
{
    ...
    public class PolicyControllerTest : IClassFixture<CustomWebApplicationFactory<DelegationsController>>
    {
        private readonly CustomWebApplicationFactory<DelegationsController> _factory;
        private readonly HttpClient _client;

        public PolicyControllerTest(CustomWebApplicationFactory<DelegationsController> fixture)
        {
            _factory = fixture;
