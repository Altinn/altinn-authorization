...
namespace Altinn.Platform.Authorization.IntegrationTests
{
    ...
    public class DelegationsControllerTest : IClassFixture<CustomWebApplicationFactory<DelegationsController>>
    {
        ...
        public DelegationsControllerTest(CustomWebApplicationFactory<DelegationsController> fixture)
        {
            _factory = fixture;
        ...
        {
            // Act
            HttpResponseMessage response = await _client.GetAsync($"accesspolicies/api/v1/delegations");
        ...
        public async Task Post_DeleteRules_Success()
        {
            ...
            // Act
            HttpResponseMessage response = await _client.PostAsync("accesspolicies/api/v1/delegations/DeleteRules", content);
        ...
        public async Task Post_DeletePolicies_InvalidUserPerformingDeleteRule_BadRequest()
        {
            ...
            // Act
            HttpResponseMessage response = await _client.PostAsync("accesspolicies/api/v1/delegations/DeletePolicy", content);
        ...
        public async Task Post_DeletePolicies_Sucess()
        {
            ...
            string textfile = File.ReadAllText("Data/Json/DeletePolicies/ReadOrg1App3App4_50001337_20001337.json");
        ...
        public async Task Post_AddRules_Unauthorized()
        {
            ...
            // Act
            HttpResponseMessage response = await _client.PostAsync("accesspolicies/api/v1/delegations/addrules", content);
        ...
        public async Task GetRules_RuleType_Is_DirectlyDelegated()
        {
            ...
            // Act
            HttpResponseMessage response = await _client.PostAsync($"accesspolicies/api/v1/delegations/getrules", content);
            string responseContent = await response.Content.ReadAsStringAsync();
